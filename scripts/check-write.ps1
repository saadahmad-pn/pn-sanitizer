...
try {
  ...
  $result = Invoke-MessagesHttpPost -Url $scanUrl -TextData $scanText -Model $Model -MaxTokens $MaxTokens -AuthToken $config.AccessToken -TimeoutSec $TimeoutSeconds -SessionId $sessionId
